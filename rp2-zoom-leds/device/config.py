...
OFFICE_WIFI_SSID = _secret("OFFICE_WIFI_SSID")
OFFICE_WIFI_PASSWORD = _secret("OFFICE_WIFI_PASSWORD")
OUTPOST_WIFI_SSID = _secret("OUTPOST_WIFI_SSID")
OUTPOST_WIFI_PASSWORD = _secret("OUTPOST_WIFI_PASSWORD")
WIFI_FALLBACK_SSID = _secret("WIFI_FALLBACK_SSID")
WIFI_FALLBACK_PASSWORD = _secret("WIFI_FALLBACK_PASSWORD")
FALLBACK_PHONE_HOTSPOT_WIFI_SSID = _secret("FALLBACK_PHONE_HOTSPOT_WIFI_SSID")
FALLBACK_PHONE_HOTSPOT_WIFI_PASSWORD = _secret("FALLBACK_PHONE_HOTSPOT_WIFI_PASSWORD")
PHONE_HOTSPOT_SSID = _secret("PHONE_HOTSPOT_SSID")
PHONE_HOTSPOT_PASSWORD = _secret("PHONE_HOTSPOT_PASSWORD")
STATE_URL = _secret("STATE_URL")
STATE_POLL_TOKEN = _secret("STATE_POLL_TOKEN", _secret("DEVICE_POLL_TOKEN", _secret("DEVICE_TOKEN")))
DEVICE_POLL_TOKEN = STATE_POLL_TOKEN
DEVICE_TOKEN = STATE_POLL_TOKEN
...
WIFI_CONFIGURED = bool(
    WIFI_SSID
    or OUTPOST_WIFI_SSID
    or OFFICE_WIFI_SSID
    or WIFI_FALLBACK_SSID
    or FALLBACK_PHONE_HOTSPOT_WIFI_SSID
    or PHONE_HOTSPOT_SSID
)

OTA_ENABLED = bool(_secret_bool("OTA_ENABLED", False) and WIFI_CONFIGURED and OTA_MANIFEST_URL)
...
NETWORK_ENABLED = bool(WIFI_CONFIGURED and (STATE_URL or OTA_ENABLED or OTA_CONFIG_ENABLED))
...
HARDWARE_WATCHDOG_ENABLED = bool(_secret_bool("HARDWARE_WATCHDOG_ENABLED", True))
...
RESOURCE_MONITOR_ENABLED = bool(_secret("RESOURCE_MONITOR_ENABLED", False))
