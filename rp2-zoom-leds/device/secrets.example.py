...
# Leave OTA_TOKEN blank for the public Cloudflare/GitHub Pages OTA path. Only
# set it for a protected OTA endpoint that expects the same low-privilege bearer
# style as /device/state.
OTA_MANIFEST_URL = "http://YOUR_RELAY_HOST/ota/manifest.json"
OTA_TOKEN = ""
